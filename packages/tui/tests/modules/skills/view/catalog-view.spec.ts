import type { SkillCatalogSnapshot } from '../../../../src/modules/skills/catalog.ts'
import { visibleWidth } from '@earendil-works/pi-tui'
import { describe, expect, it, vi } from 'vitest'
import { SkillsView } from '../../../../src/modules/skills/view/catalog-view.ts'
...
describe('SkillsView', () => {
  ...
  it('windows long catalogs without hiding the selected tail row', () => {
    ...
    view.handleAction('surface.last')
