...
} from '../../modules/composer/image-reference-presentation.ts'
import type { ComposerEditorPort } from '../../modules/composer/editor-port.ts'
...
export class InlineReferenceEditor extends Editor implements ComposerEditorPort {
  constructor(
    tui: TUI,
    theme: EditorTheme,
